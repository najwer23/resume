...
const t: any = {
	pl: {
		...
		"Creating complex SQL queries for data aggregation": "Tworzenie złożonych zapytań SQL służących do agregacji danych",
		"Creating expert systems enabling the purchase of insurance": "Tworzenie systemów eksperckich pozwalających na zakup ubezpieczenia",
		"Creating complex forms to handle insurance applications": "Tworzenie złożonych formularzy do obsługi wniosków ubezpieczeniowych",
