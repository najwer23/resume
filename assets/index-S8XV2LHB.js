...
`;const q={lang:"en",setLang:()=>{}},O=m.createContext(q),Q=({children:i})=>{const[r,a]=m.useState("en");return document.title="Mariusz Najwer - Résumé "+r.toUpperCase(),e.jsx(O.Provider,{value:{lang:r,setLang:a},children:i})},F=()=>m.useContext(O),X=i=>{const r=localStorage.getItem(i);if(!r)return null;const a=JSON.parse(r);return new Date().getTime()>a.expiry?(localStorage.removeItem(i),null):a.value},$=(i,r,a)=>{const o={value:r,expiry:new Date().getTime()+a*60*60*1e3};localStorage.setItem(i,JSON.stringify(o))};function M(i,r,a=!0){const c=m.useRef(!1),o=async z=>{if(b({type:"loading"}),!i)return;c.current=!1;const p=X(i);if(r.method==="GET"&&p){b({type:"done",payload:p});return}try{r.method!=="GET"&&(r={...r,body:JSON.stringify(z)});const S=await fetch(i,r);if(!S.ok)throw new Error(S.statusText);const P=await S.json();if(r.method==="GET"&&$(i,P,.5),c.current)return;b({type:"done",payload:P})}catch(S){if(c.current)return;b({type:"error",payload:S})}},s={error:void 0,data:void 0,status:"idle",executeFetch:o},w=(z,p)=>{switch(p.type){case"loading":return{...s,status:"loading"};case"done":return{...s,data:p.payload,status:"done"};case"error":return{...s,error:p.payload,status:"error"};default:return z}},[U,b]=m.useReducer(w,s);return m.useEffect(()=>{a&&o()},[i]),U}const _=({repoName:i})=>{const{data:r,status:a}=M(`https://api.github.com/repos/najwer23/${i}/branches/gh-pages`,{method:"GET"});let c="";return a==="done"&&(c=new Date(r.commit.commit.committer.date).toLocaleString("pl-PL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",year:"numeric"})),e.jsx(e.Fragment,{children:c||" "})},ee=()=>{const{lang:i,setLang:r}=F(),a=()=>{window.print()};return e.jsxs(K,{children:[e.jsx(Z,{children:e.jsx(_,{repoName:"resume"})}),e.jsxs(Y,{children:[e.jsx(I,{text:"EN",type:"button",ariaLabel:"lang En",onClick:()=>r("en"),disabled:i==="en"}),e.jsx(I,{text:"PL",type:"button",ariaLabel:"lang Pl",onClick:()=>r("pl"),disabled:i==="pl"}),e.jsx(I,{text:e.jsx(D,{icon:B,size:"xl",style:{color:"white"}}),type:"button",ariaLabel:"lang En",onClick:()=>a()})]})]})},te=n.div`
	margin: 1cm auto;
