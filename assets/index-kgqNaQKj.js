import{r as m,j as e}from"./react-aXXm7soD.js";import{c as J}from"./react-dom-UApmwlX7.js";import{c as W,S as G,R as H}from"./react-router-dom--bRaubkZ.js";import{n}from"./@emotion-UC1rzu6L.js";import{F as D,f as B,a as V}from"./@fortawesome-xss1EFFD.js";import{n as I}from"./najwer23storybook-J5UWJXhQ.js";/* empty css                    */import"./hoist-non-react-statics-HFhYSYcO.js";import"./scheduler-iwWdm5Ml.js";import"./react-router-WF1czFHD.js";import"./@remix-run-SZecPcY6.js";import"./@babel-dGVwEr9R.js";import"./stylis-UTZzoVRx.js";import"./prop-types-0o1MWmL_.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))c(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const w of s.addedNodes)w.tagName==="LINK"&&w.rel==="modulepreload"&&c(w)}).observe(document,{childList:!0,subtree:!0});function o(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(a){if(a.ep)return;a.ep=!0;const s=o(a);fetch(a.href,s)}})();const K=n.div`
	padding: 20px;
	gap: 20px;
	display: flex;
...
`;const q={lang:"en",setLang:()=>{}},O=m.createContext(q),Q=({children:i})=>{const[r,o]=m.useState("en");return document.title="Mariusz Najwer - Résumé "+r.toUpperCase(),e.jsx(O.Provider,{value:{lang:r,setLang:o},children:i})},F=()=>m.useContext(O),X=i=>{const r=localStorage.getItem(i);if(!r)return null;const o=JSON.parse(r);return new Date().getTime()>o.expiry?(localStorage.removeItem(i),null):o.value},$=(i,r,o)=>{const a={value:r,expiry:new Date().getTime()+o*60*60*1e3};localStorage.setItem(i,JSON.stringify(a))};function M(i,r,o=!0){const c=m.useRef(!1),a=async z=>{if(b({type:"loading"}),!i)return;c.current=!1;const p=X(i);if(r.method==="GET"&&p){b({type:"done",payload:p});return}try{r.method!=="GET"&&(r={...r,body:JSON.stringify(z)});const S=await fetch(i,r);if(!S.ok)throw new Error(S.statusText);const P=await S.json();if(r.method==="GET"&&$(i,P,.5),c.current)return;b({type:"done",payload:P})}catch(S){if(c.current)return;b({type:"error",payload:S})}},s={error:void 0,data:void 0,status:"idle",executeFetch:a},w=(z,p)=>{switch(p.type){case"loading":return{...s,status:"loading"};case"done":return{...s,data:p.payload,status:"done"};case"error":return{...s,error:p.payload,status:"error"};default:return z}},[U,b]=m.useReducer(w,s);return m.useEffect(()=>{o&&a()},[i]),U}const _=({repoName:i})=>{const{data:r,status:o}=M(`https://api.github.com/repos/najwer23/${i}/branches/gh-pages`,{method:"GET"});let c="";return o==="done"&&(c=new Date(r.commit.commit.committer.date).toLocaleString("pl-PL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",year:"numeric"})),e.jsx(e.Fragment,{children:c||" "})},ee=()=>{const{lang:i,setLang:r}=F(),o=()=>{window.print()};return e.jsxs(K,{children:[e.jsx(Z,{children:e.jsx(_,{repoName:"resume"})}),e.jsxs(Y,{children:[e.jsx(I,{text:"EN",type:"button",ariaLabel:"lang En",onClick:()=>r("en"),disabled:i==="en"}),e.jsx(I,{text:"PL",type:"button",ariaLabel:"lang Pl",onClick:()=>r("pl"),disabled:i==="pl"}),e.jsx(I,{text:e.jsx(D,{icon:B,size:"xl",style:{color:"white"}}),type:"button",ariaLabel:"lang En",onClick:()=>o()})]})]})},te=n.div`
	margin: 1cm auto;
