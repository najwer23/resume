...
const t: any = {
	pl: {
		...
		"Leading the team through frontend transformation (Angular -> React.js)": "Prowadzenie zespołu przez transformację frontendu (Angular -> React.js)",
		"Leveraging AI-powered design and development": "Wykorzystanie projektowania i rozwoju wspomaganego sztuczną inteligencją",
		"Implementing effective communication strategies and promoting a culture of continuous learning": "Wdrażanie skutecznych strategii komunikacyjnych i promowanie kultury ciągłego uczenia się",
		...
		"A resume builder is an online tool that allows me to create a professional resume.": "Kreator CV to narzędzie online, które pozwala mi szybko i łatwo stworzyć profesjonalne CV.",
