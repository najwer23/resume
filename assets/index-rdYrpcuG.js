import{r as y,j as e}from"./react-DZLWSh8C.js";import{c as J}from"./react-dom-GVliqCMN.js";import{c as U,S as G,R as H}from"./react-router-dom-D7WWcyai.js";import{n}from"./@emotion-PsvgNHYM.js";import{F as D,f as B,a as V}from"./@fortawesome-BYmqE5dj.js";import{r as A}from"./najwer23storybook-BWKlonPl.js";import{R as K}from"./react-ga4-B8xQoZVb.js";/* empty css                    */import"./hoist-non-react-statics-CqkleIqs.js";import"./scheduler-CzFDRTuY.js";import"./react-router-DrLByN2N.js";import"./@remix-run-BUbrZKbe.js";import"./@babel-CCbyfPlC.js";import"./stylis-YPZU7XtI.js";import"./prop-types-BIeFyDa8.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const f of c.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&s(f)}).observe(document,{childList:!0,subtree:!0});function o(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerPolicy&&(c.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?c.credentials="include":a.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(a){if(a.ep)return;a.ep=!0;const c=o(a);fetch(a.href,c)}})();const Y=n.div`
  padding: 20px;
  gap: 20px;
  display: flex;
...
`;const q={lang:"en",setLang:()=>{}},O=y.createContext(q),X=({children:i})=>{const[r,o]=y.useState("en");return document.title="Mariusz Najwer - Résumé "+r.toUpperCase(),e.jsx(O.Provider,{value:{lang:r,setLang:o},children:i})},F=()=>y.useContext(O),$=i=>{const r=localStorage.getItem(i);if(!r)return null;const o=JSON.parse(r);return new Date().getTime()>o.expiry?(localStorage.removeItem(i),null):o.value},_=(i,r,o)=>{const a={value:r,expiry:new Date().getTime()+o*60*60*1e3};localStorage.setItem(i,JSON.stringify(a))};function M(i,r,o=!0){const s=y.useRef(!1),a=async R=>{if(T({type:"loading"}),!i)return;s.current=!1;const x=$(i);if(r.method==="GET"&&x){T({type:"done",payload:x});return}try{r.method!=="GET"&&(r={...r,body:JSON.stringify(R)});const S=await fetch(i,r);if(!S.ok)throw new Error(S.statusText);const P=await S.json();if(r.method==="GET"&&_(i,P,.5),s.current)return;T({type:"done",payload:P})}catch(S){if(s.current)return;T({type:"error",payload:S})}},c={error:void 0,data:void 0,status:"idle",executeFetch:a},f=(R,x)=>{switch(x.type){case"loading":return{...c,status:"loading"};case"done":return{...c,data:x.payload,status:"done"};case"error":return{...c,error:x.payload,status:"error"};default:return R}},[W,T]=y.useReducer(f,c);return y.useLayoutEffect(()=>{o&&a()},[i]),W}const ee=({repoName:i})=>{const{data:r,status:o}=M(`https://api.github.com/repos/najwer23/${i}/branches/gh-pages`,{method:"GET"});let s="";return o==="done"&&(s=new Date(r.commit.commit.committer.date).toLocaleString("pl-PL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",year:"numeric"})),e.jsx(e.Fragment,{children:s||" "})},te=()=>{const{lang:i,setLang:r}=F(),o=()=>{window.print()};return e.jsxs(Y,{children:[e.jsx(Z,{children:e.jsx(ee,{repoName:"resume"})}),e.jsxs(Q,{children:[e.jsx(A,{text:"EN",type:"button",ariaLabel:"lang En",onClick:()=>r("en"),disabled:i==="en"}),e.jsx(A,{text:"PL",type:"button",ariaLabel:"lang Pl",onClick:()=>r("pl"),disabled:i==="pl"}),e.jsx(A,{text:e.jsx(D,{icon:B,size:"xl",style:{color:"white"}}),type:"button",ariaLabel:"lang En",onClick:()=>o()})]})]})},re=n.div`
  margin: 1cm auto;
