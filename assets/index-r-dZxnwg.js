import{r as m,j as e}from"./react-aXXm7soD.js";import{c as J}from"./react-dom-UApmwlX7.js";import{c as W,S as G,R as H}from"./react-router-dom--bRaubkZ.js";import{n}from"./@emotion-UC1rzu6L.js";import{F as D,f as B,a as V}from"./@fortawesome-xss1EFFD.js";import{n as I}from"./najwer23storybook-J5UWJXhQ.js";/* empty css                    */import"./hoist-non-react-statics-HFhYSYcO.js";import"./scheduler-iwWdm5Ml.js";import"./react-router-WF1czFHD.js";import"./@remix-run-SZecPcY6.js";import"./@babel-dGVwEr9R.js";import"./stylis-UTZzoVRx.js";import"./prop-types-0o1MWmL_.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))c(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const w of s.addedNodes)w.tagName==="LINK"&&w.rel==="modulepreload"&&c(w)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const K=n.div`
	padding: 20px;
	gap: 20px;
	display: flex;
...
`;const q={lang:"en",setLang:()=>{}},O=m.createContext(q),Q=({children:i})=>{const[r,a]=m.useState("en");return document.title="Mariusz Najwer - Résumé "+r.toUpperCase(),e.jsx(O.Provider,{value:{lang:r,setLang:a},children:i})},F=()=>m.useContext(O),X=i=>{const r=localStorage.getItem(i);if(!r)return null;const a=JSON.parse(r);return new Date().getTime()>a.expiry?(localStorage.removeItem(i),null):a.value},$=(i,r,a)=>{const o={value:r,expiry:new Date().getTime()+a*60*60*1e3};localStorage.setItem(i,JSON.stringify(o))};function M(i,r,a=!0){const c=m.useRef(!1),o=async z=>{if(b({type:"loading"}),!i)return;c.current=!1;const h=X(i);if(r.method==="GET"&&h){b({type:"done",payload:h});return}try{r.method!=="GET"&&(r={...r,body:JSON.stringify(z)});const f=await fetch(i,r);if(!f.ok)throw new Error(f.statusText);const P=await f.json();if(r.method==="GET"&&$(i,P,.5),c.current)return;b({type:"done",payload:P})}catch(f){if(c.current)return;b({type:"error",payload:f})}},s={error:void 0,data:void 0,status:"idle",executeFetch:o},w=(z,h)=>{switch(h.type){case"loading":return{...s,status:"loading"};case"done":return{...s,data:h.payload,status:"done"};case"error":return{...s,error:h.payload,status:"error"};default:return z}},[U,b]=m.useReducer(w,s);return m.useEffect(()=>{a&&o()},[i]),U}const _=({repoName:i})=>{const{data:r,status:a}=M(`https://api.github.com/repos/najwer23/${i}/branches/gh-pages`,{method:"GET"});let c="";return a==="done"&&(c=new Date(r.commit.commit.committer.date).toLocaleString("pl-PL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",year:"numeric"})),e.jsx(e.Fragment,{children:c||" "})},ee=()=>{const{lang:i,setLang:r}=F(),a=()=>{window.print()};return e.jsxs(K,{children:[e.jsx(Y,{children:e.jsx(_,{repoName:"resume"})}),e.jsxs(Z,{children:[e.jsx(I,{text:"EN",type:"button",ariaLabel:"lang En",onClick:()=>r("en"),disabled:i==="en"}),e.jsx(I,{text:"PL",type:"button",ariaLabel:"lang Pl",onClick:()=>r("pl"),disabled:i==="pl"}),e.jsx(I,{text:e.jsx(D,{icon:B,size:"xl",style:{color:"white"}}),type:"button",ariaLabel:"lang En",onClick:()=>a()})]})]})},te=n.div`
	margin: 1cm auto;
...
`,je=()=>e.jsxs(N,{children:[e.jsx(C,{children:t("EDUCATION")}),e.jsx(E,{}),e.jsxs(S,{children:[e.jsxs(j,{children:[e.jsx(g,{children:e.jsx("img",{src:"img/pwr.png",alt:"pwr logo"})}),e.jsxs(u,{children:[e.jsx(x,{children:t("WROCŁAW UNIVERSITY OF SCIENCE AND TECHNOLOGY")}),e.jsxs(y,{children:[e.jsx(p,{children:t("Master of Science, COMPUTER SCIENCE, 4.5")}),e.jsx(p,{children:t("2018.02 ‑ 2019.06, Wrocław")})]})]})]}),e.jsxs(j,{children:[e.jsx(g,{children:e.jsx("img",{src:"img/pwr.png",alt:"pwr logo"})}),e.jsxs(u,{children:[e.jsx(x,{children:t("WROCŁAW UNIVERSITY OF SCIENCE AND TECHNOLOGY")}),e.jsxs(y,{children:[e.jsx(p,{children:t("Bachelor of Science, CONTROL ENGINEERING AND ROBOTICS, 4.5")}),e.jsx(p,{children:t("2014.10 ‑ 2018.01, Wrocław")})]})]})]})]})]}),ge=()=>e.jsxs(e.Fragment,{children:[e.jsx(C,{children:t("EXPERIENCE")}),e.jsx(E,{})]}),ue=()=>e.jsx(S,{children:e.jsxs(j,{children:[e.jsx(g,{children:e.jsx("img",{src:"img/1dea.jpg",alt:"1dea logo"})}),e.jsxs(u,{children:[e.jsx(x,{children:t("1dea - FRONTEND SOFTWARE ENGINEER")}),e.jsxs(y,{children:[e.jsx(p,{children:t("2023.08.07 – current")}),e.jsx(R,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[t("Client from the entertainment industry (~100 000 000 users)")," "]}),e.jsxs("li",{children:[t("Micro-frontend architecture")," "]}),e.jsxs("li",{children:[t("Creating SSR components")," "]}),e.jsxs("li",{children:[t("Impact on design system")," "]}),e.jsxs("li",{children:[t("Improving website performance")," "]}),e.jsxs("li",{children:[t("Cooperation with the testing team")," "]}),e.jsxs("li",{children:[t("a11y")," "]})]})}),e.jsx(A,{children:"(JavaScript, TypeScript, Web Components, React.js, Next.js, Redux.js, CSS3, CSS Modules, HTML, Node.js, REST APIs, JSON, GraphQL, Search Engine Optimization (SEO), Scrum, JIRA, Core Web Vitals, Figma, Astro, Stroybook, Vite)"})]})]})]})}),xe=()=>e.jsx(S,{children:e.jsxs(j,{children:[e.jsx(g,{children:e.jsx("img",{src:"img/flhf.png",alt:"flhf logo"})}),e.jsxs(u,{children:[e.jsx(x,{children:t("FLHF S.A - FRONTEND WEB DEVELOPER")}),e.jsxs(y,{children:[e.jsx(p,{children:t("2021.11.01 – 2023.04.30; 1 year, 6 months")}),e.jsx(R,{children:e.jsxs("ul",{children:[e.jsxs("li",{children:[t("Client from the ecommerce industry (Income: ~4 000 000 PLN)")," "]}),e.jsx("li",{children:t("Creating and changing functionality on the website (Store search engine, Blog page, Shopping cart, Checkout, Sliders, Carousel, Filters etc.)")}),e.jsx("li",{children:t("Improving website performance")}),e.jsx("li",{children:t("Collaboration with the devops team")}),e.jsx("li",{children:t("Email templates")}),e.jsx("li",{children:t("a11y")})]})}),e.jsx(A,{children:"(JavaScript, jQuery, React.js, TypeScript, HTML5, CSS3, JSON, GraphQL, Search Engine Optimization (SEO), Core Web Vitals, Magento2, Scrum, Jira)"})]})]})]})}),ye=()=>e.jsx(S,{children:e.jsxs(j,{children:[e.jsx(g,{children:e.jsx("img",{src:"img/e.jpg",alt:"europa logo"})}),e.jsxs(u,{children:[e.jsx(x,{children:t("EUROPA UBEZPIECZENIA - FULL STACK DEVELOPER")}),e.jsxs(y,{children:[e.jsx(p,{children:t("2019.09.01 – 2021.10.31; 2 years, 2 months")}),e.jsx(R,{children:e.jsxs("ul",{children:[e.jsx("li",{children:t("Client from the insurance industry (Income: ~5 000 000 PLN)")}),e.jsx("li",{children:t("Creating expert systems enabling the purchase of insurance")}),e.jsx("li",{children:t("Creating complex forms to handle insurance applications")}),e.jsx("li",{children:t("Cooperation with business analysts")}),e.jsx("li",{children:t("Email templates")}),e.jsx("li",{children:t("Creating complex SQL queries for data aggregation")}),e.jsx("li",{children:t("Creating database models for web applications")})]})}),e.jsx(A,{children:"(Angular, Angular.js, Typescript, JavaScript, jQuery, HTML5, CSS3, Groovy, PHP, XML, JSON, Scrum, Jira)"})]})]})]})}),we=()=>e.jsx(S,{children:e.jsxs(j,{children:[e.jsx(g,{children:e.jsx("img",{src:"img/o.png",alt:"orange logo"})}),e.jsxs(u,{children:[e.jsx(x,{children:t("Orange - INTERN")}),e.jsx(y,{children:e.jsx(p,{children:t("2017.07; 1 month")})})]})]})}),T=({title:i,number:r})=>{let a={1:e.jsx(we,{}),2:e.jsx(ye,{}),3:e.jsx(xe,{}),4:e.jsx(ue,{})};return e.jsxs(N,{children:[i&&e.jsx(ge,{}),a[r??1]]})},L={"tel:+48519792189":e.jsxs(e.Fragment,{children:["+48"," ","519"," ","792"," ","189"]}),"mailto:najwer23@live.com":"najwer23@live.com","https://najwer23.github.io":"https://najwer23.github.io","https://www.linkedin.com/in/najwer23":e.jsx("b",{children:"https://www.linkedin.com/in/najwer23"})},fe=()=>e.jsx(e.Fragment,{children:e.jsxs(re,{children:[e.jsxs(ie,{children:[e.jsxs(ne,{children:[e.jsx("b",{children:"Mariusz"})," Najwer"]}),e.jsx(ae,{children:e.jsx("b",{children:"Frontend Software Engineer"})})]}),e.jsx(oe,{children:Object.keys(L).map((i,r)=>e.jsx(se,{children:e.jsx("a",{href:i,rel:"noreferrer",target:"_blank",children:L[i]},r)},r))})]})}),Se=()=>e.jsxs(N,{children:[e.jsx(C,{children:t("MY PROJECTS")}),e.jsx(E,{})]}),be=()=>e.jsx(l,{projectTitle:e.jsx(e.Fragment,{children:t("DESIGN SYSTEM (npm package)")}),projectTech:e.jsx(e.Fragment,{children:"(React.js, Typescript, JavaScript, CSS Modules, Storybook, Vite, Webpack, Rollup.js, npm package)"}),projcetDesc:e.jsx("ul",{children:e.jsx("li",{children:t("This package offers a range of design system assets, including components, styles, and guidelines, to facilitate the development of consistent and user-friendly interfaces across various applications and platforms")})}),projectLink:"https://najwer23.github.io/najwer23storybook"}),ke=()=>e.jsx(l,{projectTitle:e.jsxs(e.Fragment,{children:[t("TVN Warner Bros. Discovery, TVN24 - digital news")," ✨✨"]}),projectTech:e.jsx(e.Fragment,{children:"(Next.js, React.js, Typescript, JavaScript, CSS-IN-JS, CSS Modules, Redux, Figma, Storybook, d3.js)"}),projcetDesc:e.jsxs("ul",{children:[e.jsxs("li",{children:[t("Polish Parliamentary Elections 2023")," "]}),e.jsxs("li",{children:[t("Weather widgets")," "]}),e.jsxs("li",{children:[t("Stock quotes")," "]}),e.jsxs("li",{children:[t("Electronic Program Guide")," "]}),e.jsxs("li",{children:[t("Top model 2023")," "]})]}),projectLink:"https://tvn24.pl/"}),Te=()=>e.jsx(l,{projectTitle:e.jsxs(e.Fragment,{children:[t("ONLINE INSURANCE APPLICATIONS")," "]}),projectTech:e.jsx(e.Fragment,{children:"(HTML, JavaScript, TypeScript, jQuery, Angular, SQL)"}),projcetDesc:e.jsxs("ul",{children:[e.jsxs("li",{children:[t("LIFE AND HEALTH INSURANCE")," "]}),e.jsxs("li",{children:[t("APARTMENT AND HOUSE INSURANCE")," "]}),e.jsxs("li",{children:[t("ACTIVE IN SPORT")," "]}),e.jsxs("li",{children:[t("ITRAVEL")," "]})]}),projectLink:"https://tueuropa.pl/"}),Ce=()=>e.jsx(l,{projectTitle:e.jsxs(e.Fragment,{children:[t("RESTILO")," "]}),projectTech:e.jsx(e.Fragment,{children:"(HTML, JavaScript, TypeScript, jQuery, React.js)"}),projcetDesc:e.jsx("ul",{children:e.jsxs("li",{children:[t("Online store allowing you to purchase home things")," "]})}),projectLink:"https://restilo.pl/"}),Ee=()=>e.jsx(l,{projectTitle:e.jsxs(e.Fragment,{children:[t("SUDOKU")," "]}),projectTech:e.jsx(e.Fragment,{children:"(HTML5, CSS3-IN-JS, JavaScript, TypeScript, backtracking algorithm)"}),projcetDesc:e.jsx("ul",{children:e.jsxs("li",{children:[t("Sudoku is a popular logic-based number-placement game. The goal is to fill a 9x9 grid with digits so that each column, each row, and each of the nine 3x3 subgrids that compose the grid contain all of the digits from 1 to 9. It is a highly engaging puzzle that can help improve concentration and overall brain power")," "]})}),projectLink:"https://najwer23.github.io/sudoku/"}),ze=()=>e.jsx(l,{projectTitle:e.jsx(e.Fragment,{children:t("BLACKJACK")}),projectTech:e.jsx(e.Fragment,{children:"(HTML5, CSS3, JavaScript)"}),projcetDesc:e.jsx("ul",{children:e.jsxs("li",{children:[t("Blackjack is a casino banking game. The game is a comparing card game where each player competes against the dealer. The objective of the game is to get a hand total of closer to 21 than the dealer without going over 21(busting)")," "]})}),projectLink:"https://najwer23.github.io/blackjack/"}),Ie=()=>e.jsx(l,{projectTitle:e.jsx(e.Fragment,{children:t("GUI Snippets")}),projectTech:e.jsx(e.Fragment,{children:"(JavaScript, HTML5, CSS3)"}),projcetDesc:e.jsx("ul",{children:e.jsxs("li",{children:[t("Calendar, Carousel, Slider, Scrollbar, Masonry Grid, Video Player, Email HTML, Slideshow")," "]})}),projectLink:"https://najwer23.github.io/gui-challenge/"}),Ne=()=>e.jsx(l,{projectTitle:e.jsxs(e.Fragment,{children:[t("REED SOLOMON ALGORITHM BCH: ENCODER, DECODER")," "]}),projectTech:e.jsx(e.Fragment,{children:"(JavaScript, HTML5, CSS3, Webpack, LaTeX - Mathjax)"}),projcetDesc:e.jsxs("ul",{children:[e.jsxs("li",{children:[t("Reed-Solomon algorithm is an error-correcting code that is widely used in various applications, including data storage systems such as CDs, DVDs, Blu-ray discs, and RAID 6")," "]}),e.jsxs("li",{children:[t("Reed-Solomon codes are used to detect and correct burst errors associated with media defects")," "]}),e.jsx("li",{children:t("Algorithms used: Gauss-Jordan Elimination in Galois field, Detrminant, Transpose of Matrix n*n, Zech’s logarithm, Adding, Multiplication and Dividing polynomials, Peterson–Gorenstein–Zierler algorithm, Chien search algorithm, System of linear equations")})]}),projectLink:"https://najwer23.github.io/bch-code-js/"}),Re=()=>e.jsx(l,{projectTitle:e.jsxs(e.Fragment,{children:[t("APP SUPPORTING CALISTHENICS TRAINING")," "]}),projectTech:e.jsx(e.Fragment,{children:"(React.js, Node.js (Express.js), DynamoDB, CSS)"}),projcetDesc:e.jsxs("ul",{children:[e.jsxs("li",{children:[t("100 Push Ups, 300 Squats, 300 Sit Ups, 40 Pull Ups training plans")," "]}),e.jsxs("li",{children:[t("Authorization and communication with API in the cloud")," "]}),e.jsxs("li",{children:[t("Email templates")," "]})]}),projectLink:"https://jabber.cyclic.app"}),Ae=()=>e.jsx(l,{projectTitle:e.jsx(e.Fragment,{children:t("TOP MUSIC HITS")}),projectTech:e.jsx(e.Fragment,{children:"(React.js, Recoil.js, JavaScript, TypeScript, TailwindCSS)"}),projcetDesc:e.jsx("ul",{children:e.jsxs("li",{children:[t("The application displays current music hits and allow to filters by title or author.")," "]})}),projectLink:"https://najwer23.github.io/top-100-music/"}),Pe=()=>e.jsx(l,{projectTitle:e.jsx(e.Fragment,{children:t("WEATHER APP")}),projectTech:e.jsx(e.Fragment,{children:"(React.js, Redux.js, JavaScript, TypeScript, CSS modules, DynamoDB, Node.js, Vite)"}),projcetDesc:e.jsxs("ul",{children:[e.jsxs("li",{children:[t("The project was about integrating an external API using Redux.js and AWS")," "]}),e.jsx("li",{children:t("Displays weather data for specific geographic coordinates")})]}),projectLink:"https://najwer23.github.io/#/weather"}),ve=()=>e.jsx(l,{projectTitle:e.jsx(e.Fragment,{children:t("GEOMETRIC FIGURES WITH BOUNDING BOX")}),projectTech:e.jsx(e.Fragment,{children:"(React.js, Redux.js, JavaScript, TypeScript, HTML5, CSS3)"}),projcetDesc:e.jsx("ul",{children:e.jsxs("li",{children:[t("An application that draws rotated geometric figures (rectangles and ellipses) on a canvas based on data from the API. For each figure it was necessary to draw a 'bounding box'")," "]})}),projectLink:"https://najwer23.github.io/react-redux-ts/"}),Le=()=>e.jsx(l,{projectTitle:e.jsx(e.Fragment,{children:t("RESUME BUILDER")}),projectTech:e.jsx(e.Fragment,{children:"(JavaScript, TypeScript, React.js, CSS, Emotion, Vite)"}),projcetDesc:e.jsx("ul",{children:e.jsxs("li",{children:[t("A resume builder is an online tool that allows me to create a professional resume quickly and easily.")," "]})}),projectLink:"https://najwer23.github.io/resume/"}),De=()=>{const{data:i,status:r}=M("https://leetcode-api-faisalshohag.vercel.app/najwer23",{method:"GET",headers:{"Content-Type":"application/json",Accept:"application/json"}},!0);let a="";return r==="done"&&(a=i.totalSolved),e.jsx(l,{projectTitle:e.jsxs(e.Fragment,{children:[t("LEETCODE")," ✨"]}),projectTech:e.jsx(e.Fragment,{children:"(JavaScript, TypeScript, Node.js)"}),projcetDesc:e.jsx("ul",{children:e.jsxs("li",{children:[t("Number of currently solved problems:")," ",a||"600+"]})}),projectLink:"https://leetcode.com/najwer23/"})},l=({projectTitle:i,projectTech:r,projcetDesc:a,projectLink:c})=>e.jsxs(e.Fragment,{children:[e.jsx(de,{children:i}),e.jsx(pe,{children:r}),e.jsx(he,{children:a}),e.jsx("a",{href:c,rel:"noreferrer",target:"_blank",style:{fontSize:"12px"},children:c})]}),d=({title:i,number:r})=>{let a={1:e.jsx(De,{}),2:e.jsx(Le,{}),3:e.jsx(ve,{}),4:e.jsx(Pe,{}),5:e.jsx(Ae,{}),6:e.jsx(Re,{}),7:e.jsx(Ne,{}),8:e.jsx(Ie,{}),9:e.jsx(ze,{}),10:e.jsx(Ee,{}),11:e.jsx(Ce,{}),12:e.jsx(Te,{}),13:e.jsx(ke,{}),14:e.jsx(be,{})};return e.jsxs(e.Fragment,{children:[i&&e.jsx(Se,{}),a[r??1],e.jsx(me,{})]})},Oe=["JavaScript","TypeScript","React.js","Angular","jQuery","Next.js","Redux.js","Recoil.js","MobX.js","Knokout.js","Cypress","Jtest.js","Puppeteer","HTML5","CSS (Less, Sass, CSS-IN-JS, modules)","Tailwind CSS","PHP","Node.js","Storybook","Design system","AWS (DynamoDB, S3, RDS, E3)","XML, JSON, GraphQL","Express.js","Agile, Scrum & JIRA","Web Components","Leaflet","Core Web Vitals","Search Engine Optimization(SEO)","a11y","SSR"],Fe=()=>e.jsxs(e.Fragment,{children:[e.jsx(C,{children:t("SKILLS")}),e.jsx(E,{}),e.jsx(ce,{children:Oe.map((i,r,a)=>e.jsxs(le,{children:[e.jsx("div",{children:a[r]}),e.jsx("div",{children:r<a.length-1?e.jsx(D,{icon:V,size:"2xs",style:{color:"orangered",marginLeft:"10px"}}):""})]},r))})]}),Me=()=>e.jsxs(e.Fragment,{children:[e.jsx(ee,{}),e.jsxs(k,{children:[e.jsx(fe,{}),e.jsx(je,{}),e.jsx(T,{title:!0,number:4}),e.jsx(T,{number:3})]}),e.jsxs(k,{children:[e.jsx(T,{number:2}),e.jsx(T,{number:1}),e.jsx("br",{}),e.jsx(Fe,{}),e.jsx(d,{title:!0,number:1}),e.jsx(d,{number:2})]}),e.jsxs(k,{children:[e.jsx(d,{number:4}),e.jsx(d,{number:3}),e.jsx(d,{number:6}),e.jsx(d,{number:7}),e.jsx(d,{number:9})]}),e.jsxs(k,{children:[e.jsx(d,{number:10}),e.jsx(d,{number:11}),e.jsx(d,{number:12}),e.jsx(d,{number:14}),e.jsx(d,{number:13})]})]}),Ue=W([{path:"/",element:e.jsxs(e.Fragment,{children:[e.jsx(Me,{}),e.jsx(G,{})]})}]),Je=()=>e.jsx(H,{router:Ue}),We=()=>e.jsx(Q,{children:e.jsx(Je,{})});J.createRoot(document.getElementById("root")).render(e.jsx(We,{}));
