import{r as m,j as e}from"./react-aXXm7soD.js";import{c as J}from"./react-dom-UApmwlX7.js";import{c as W,S as G,R as H}from"./react-router-dom--bRaubkZ.js";import{n}from"./@emotion-UC1rzu6L.js";import{F as O,f as B,a as K}from"./@fortawesome-xss1EFFD.js";import{n as I}from"./najwer23storybook-J5UWJXhQ.js";/* empty css                    */import"./hoist-non-react-statics-HFhYSYcO.js";import"./scheduler-iwWdm5Ml.js";import"./react-router-WF1czFHD.js";import"./@remix-run-SZecPcY6.js";import"./@babel-dGVwEr9R.js";import"./stylis-UTZzoVRx.js";import"./prop-types-0o1MWmL_.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))c(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const w of s.addedNodes)w.tagName==="LINK"&&w.rel==="modulepreload"&&c(w)}).observe(document,{childList:!0,subtree:!0});function a(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(o){if(o.ep)return;o.ep=!0;const s=a(o);fetch(o.href,s)}})();const V=n.div`
	padding: 20px;
	gap: 20px;
	display: flex;
...
`;const q={lang:"en",setLang:()=>{}},D=m.createContext(q),Q=({children:i})=>{const[r,a]=m.useState("en");return document.title="Mariusz Najwer - Résumé "+r.toUpperCase(),e.jsx(D.Provider,{value:{lang:r,setLang:a},children:i})},F=()=>m.useContext(D),X=i=>{const r=localStorage.getItem(i);if(!r)return null;const a=JSON.parse(r);return new Date().getTime()>a.expiry?(localStorage.removeItem(i),null):a.value},$=(i,r,a)=>{const o={value:r,expiry:new Date().getTime()+a*60*60*1e3};localStorage.setItem(i,JSON.stringify(o))};function M(i,r,a=!0){const c=m.useRef(!1),o=async z=>{if(b({type:"loading"}),!i)return;c.current=!1;const p=X(i);if(r.method==="GET"&&p){b({type:"done",payload:p});return}try{r.method!=="GET"&&(r={...r,body:JSON.stringify(z)});const S=await fetch(i,r);if(!S.ok)throw new Error(S.statusText);const P=await S.json();if(r.method==="GET"&&$(i,P,.5),c.current)return;b({type:"done",payload:P})}catch(S){if(c.current)return;b({type:"error",payload:S})}},s={error:void 0,data:void 0,status:"idle",executeFetch:o},w=(z,p)=>{switch(p.type){case"loading":return{...s,status:"loading"};case"done":return{...s,data:p.payload,status:"done"};case"error":return{...s,error:p.payload,status:"error"};default:return z}},[U,b]=m.useReducer(w,s);return m.useEffect(()=>{a&&o()},[i]),U}const _=({repoName:i})=>{const{data:r,status:a}=M(`https://api.github.com/repos/najwer23/${i}/branches/gh-pages`,{method:"GET"});let c="";return a==="done"&&(c=new Date(r.commit.commit.committer.date).toLocaleString("pl-PL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",year:"numeric"})),e.jsx(e.Fragment,{children:c||" "})},ee=()=>{const{lang:i,setLang:r}=F(),a=()=>{window.print()};return e.jsxs(V,{children:[e.jsx(Z,{children:e.jsx(_,{repoName:"resume"})}),e.jsxs(Y,{children:[e.jsx(I,{text:"EN",type:"button",ariaLabel:"lang En",onClick:()=>r("en"),disabled:i==="en"}),e.jsx(I,{text:"PL",type:"button",ariaLabel:"lang Pl",onClick:()=>r("pl"),disabled:i==="pl"}),e.jsx(I,{text:e.jsx(O,{icon:B,size:"xl",style:{color:"white"}}),type:"button",ariaLabel:"lang En",onClick:()=>a()})]})]})},te=n.div`
	margin: 1cm auto;
