import{r as y,j as e}from"./react-DZLWSh8C.js";import{c as J}from"./react-dom-CcTSMvaW.js";import{c as U,S as G,R as H}from"./react-router-dom-B_J-Rp1a.js";import{n}from"./@emotion-PsvgNHYM.js";import{F as D,f as B,a as V}from"./@fortawesome-BYmqE5dj.js";import{r as N}from"./najwer23storybook-BWKlonPl.js";/* empty css                    */import"./hoist-non-react-statics-CqkleIqs.js";import"./scheduler-CzFDRTuY.js";import"./react-router-BY0H6YA9.js";import"./@remix-run-ByG8zGTJ.js";import"./@babel-CCbyfPlC.js";import"./stylis-YPZU7XtI.js";import"./prop-types-BIeFyDa8.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const c of o)if(c.type==="childList")for(const S of c.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&a(S)}).observe(document,{childList:!0,subtree:!0});function s(o){const c={};return o.integrity&&(c.integrity=o.integrity),o.referrerPolicy&&(c.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?c.credentials="include":o.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function a(o){if(o.ep)return;o.ep=!0;const c=s(o);fetch(o.href,c)}})();const K=n.div`
	padding: 20px;
	gap: 20px;
	display: flex;
...
`;const Q={lang:"en",setLang:()=>{}},O=y.createContext(Q),q=({children:i})=>{const[r,s]=y.useState("en");return document.title="Mariusz Najwer - Résumé "+r.toUpperCase(),e.jsx(O.Provider,{value:{lang:r,setLang:s},children:i})},F=()=>y.useContext(O),X=i=>{const r=localStorage.getItem(i);if(!r)return null;const s=JSON.parse(r);return new Date().getTime()>s.expiry?(localStorage.removeItem(i),null):s.value},$=(i,r,s)=>{const o={value:r,expiry:new Date().getTime()+s*60*60*1e3};localStorage.setItem(i,JSON.stringify(o))};function M(i,r,s=!0){const a=y.useRef(!1),o=async R=>{if(T({type:"loading"}),!i)return;a.current=!1;const x=X(i);if(r.method==="GET"&&x){T({type:"done",payload:x});return}try{r.method!=="GET"&&(r={...r,body:JSON.stringify(R)});const f=await fetch(i,r);if(!f.ok)throw new Error(f.statusText);const P=await f.json();if(r.method==="GET"&&$(i,P,.5),a.current)return;T({type:"done",payload:P})}catch(f){if(a.current)return;T({type:"error",payload:f})}},c={error:void 0,data:void 0,status:"idle",executeFetch:o},S=(R,x)=>{switch(x.type){case"loading":return{...c,status:"loading"};case"done":return{...c,data:x.payload,status:"done"};case"error":return{...c,error:x.payload,status:"error"};default:return R}},[W,T]=y.useReducer(S,c);return y.useLayoutEffect(()=>{s&&o()},[i]),W}const _=({repoName:i})=>{const{data:r,status:s}=M(`https://api.github.com/repos/najwer23/${i}/branches/gh-pages`,{method:"GET"});let a="";return s==="done"&&(a=new Date(r.commit.commit.committer.date).toLocaleString("pl-PL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",year:"numeric"})),e.jsx(e.Fragment,{children:a||" "})},ee=()=>{const{lang:i,setLang:r}=F(),s=()=>{window.print()};return e.jsxs(K,{children:[e.jsx(Y,{children:e.jsx(_,{repoName:"resume"})}),e.jsxs(Z,{children:[e.jsx(N,{text:"EN",type:"button",ariaLabel:"lang En",onClick:()=>r("en"),disabled:i==="en"}),e.jsx(N,{text:"PL",type:"button",ariaLabel:"lang Pl",onClick:()=>r("pl"),disabled:i==="pl"}),e.jsx(N,{text:e.jsx(D,{icon:B,size:"xl",style:{color:"white"}}),type:"button",ariaLabel:"lang En",onClick:()=>s()})]})]})},te=n.div`
	margin: 1cm auto;
