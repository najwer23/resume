import{r as y,j as e}from"./react-DZLWSh8C.js";import{c as G}from"./react-dom-GVliqCMN.js";import{c as J,S as U,R as H}from"./react-router-dom-C54e82H_.js";import{n}from"./@emotion-BesKrtjP.js";import{F as D,f as B,a as V}from"./@fortawesome-DtYJQ0nF.js";import{r as A}from"./najwer23snacks-DWlfLNZL.js";import{R as K}from"./react-ga4-B8xQoZVb.js";/* empty css                    */import"./hoist-non-react-statics-CqkleIqs.js";import"./scheduler-CzFDRTuY.js";import"./react-router-BpcWZgH_.js";import"./@remix-run-DwH2_trI.js";import"./@babel-CF3RwP-h.js";import"./stylis-YPZU7XtI.js";import"./prop-types-BIeFyDa8.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const f of c.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&s(f)}).observe(document,{childList:!0,subtree:!0});function o(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerPolicy&&(c.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?c.credentials="include":a.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(a){if(a.ep)return;a.ep=!0;const c=o(a);fetch(a.href,c)}})();const Y=n.div`
  padding: 20px;
  gap: 20px;
  display: flex;
...
`;const q={lang:"en",setLang:()=>{}},O=y.createContext(q),X=({children:r})=>{const[i,o]=y.useState("en");return document.title="Mariusz Najwer - Résumé "+i.toUpperCase(),e.jsx(O.Provider,{value:{lang:i,setLang:o},children:r})},F=()=>y.useContext(O),$=r=>{const i=localStorage.getItem(r);if(!i)return null;const o=JSON.parse(i);return new Date().getTime()>o.expiry?(localStorage.removeItem(r),null):o.value},_=(r,i,o)=>{const a={value:i,expiry:new Date().getTime()+o*60*60*1e3};localStorage.setItem(r,JSON.stringify(a))};function M(r,i,o=!0){const s=y.useRef(!1),a=async R=>{if(T({type:"loading"}),!r)return;s.current=!1;const x=$(r);if(i.method==="GET"&&x){T({type:"done",payload:x});return}try{i.method!=="GET"&&(i={...i,body:JSON.stringify(R)});const S=await fetch(r,i);if(!S.ok)throw new Error(S.statusText);const P=await S.json();if(i.method==="GET"&&_(r,P,.5),s.current)return;T({type:"done",payload:P})}catch(S){if(s.current)return;T({type:"error",payload:S})}},c={error:void 0,data:void 0,status:"idle",executeFetch:a},f=(R,x)=>{switch(x.type){case"loading":return{...c,status:"loading"};case"done":return{...c,data:x.payload,status:"done"};case"error":return{...c,error:x.payload,status:"error"};default:return R}},[W,T]=y.useReducer(f,c);return y.useLayoutEffect(()=>{o&&a()},[r]),W}const ee=({repoName:r})=>{const{data:i,status:o}=M(`https://api.github.com/repos/najwer23/${r}/branches/gh-pages`,{method:"GET"});let s="";return o==="done"&&(s=new Date(i.commit.commit.committer.date).toLocaleString("pl-PL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",year:"numeric"})),e.jsx(e.Fragment,{children:s||" "})},te=()=>{const{lang:r,setLang:i}=F(),o=()=>{window.print()};return e.jsxs(Y,{children:[e.jsx(Z,{children:e.jsx(ee,{repoName:"resume"})}),e.jsxs(Q,{children:[e.jsx(A,{type:"button","aria-label":"lang En",onClick:()=>i("en"),disabled:r==="en",children:"EN"}),e.jsx(A,{type:"button","aria-label":"lang Pl",onClick:()=>i("pl"),disabled:r==="pl",children:"PL"}),e.jsx(A,{type:"button","aria-label":"lang En",onClick:()=>o(),children:e.jsx(D,{icon:B,size:"xl",style:{color:"white"}})})]})]})},re=n.div`
  margin: 1cm auto;
