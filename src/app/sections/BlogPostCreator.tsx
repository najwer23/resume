...
export const BlogPostCreator: React.FC<{}> = ({}) => {
  return (
    <Grid widthMax={'1400px'} layout="flex" justifyContent="flex-start" margin={'15px 0 0 0'}>
      ...
      <Grid widthMax={'700px'} layout="container" margin={0}>
        ...
        <TextBox color="black" mobileSize={12} desktopSize={12} fontWeight={400} tag="h3">
          (React.js, TypeScript, Zustand, Drag & Drop, Design System, Local Storage)
        </TextBox>
        <TextBox
          color="black"
          mobileSize={14}
        ...
        <TextBox
          ...
          target="_blank"
        >
          https://najwer23.github.io/blog-post-creator
        </TextBox>
      </Grid>
    </Grid>
  );
