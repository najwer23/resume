import{r as m,j as e}from"./react-DZLWSh8C.js";import{c as U}from"./react-dom-CcTSMvaW.js";import{c as J,S as G,R as H}from"./react-router-dom-B_J-Rp1a.js";import{n}from"./@emotion-PsvgNHYM.js";import{F as D,f as B,a as V}from"./@fortawesome-BYmqE5dj.js";import{r as I}from"./najwer23storybook-BWKlonPl.js";/* empty css                    */import"./hoist-non-react-statics-CqkleIqs.js";import"./scheduler-CzFDRTuY.js";import"./react-router-BY0H6YA9.js";import"./@remix-run-ByG8zGTJ.js";import"./@babel-CCbyfPlC.js";import"./stylis-YPZU7XtI.js";import"./prop-types-BIeFyDa8.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))c(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const w of s.addedNodes)w.tagName==="LINK"&&w.rel==="modulepreload"&&c(w)}).observe(document,{childList:!0,subtree:!0});function o(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(a){if(a.ep)return;a.ep=!0;const s=o(a);fetch(a.href,s)}})();const K=n.div`
	padding: 20px;
	gap: 20px;
	display: flex;
...
`;const q={lang:"en",setLang:()=>{}},O=m.createContext(q),Q=({children:i})=>{const[r,o]=m.useState("en");return document.title="Mariusz Najwer - Résumé "+r.toUpperCase(),e.jsx(O.Provider,{value:{lang:r,setLang:o},children:i})},F=()=>m.useContext(O),X=i=>{const r=localStorage.getItem(i);if(!r)return null;const o=JSON.parse(r);return new Date().getTime()>o.expiry?(localStorage.removeItem(i),null):o.value},$=(i,r,o)=>{const a={value:r,expiry:new Date().getTime()+o*60*60*1e3};localStorage.setItem(i,JSON.stringify(a))};function M(i,r,o=!0){const c=m.useRef(!1),a=async z=>{if(b({type:"loading"}),!i)return;c.current=!1;const h=X(i);if(r.method==="GET"&&h){b({type:"done",payload:h});return}try{r.method!=="GET"&&(r={...r,body:JSON.stringify(z)});const S=await fetch(i,r);if(!S.ok)throw new Error(S.statusText);const P=await S.json();if(r.method==="GET"&&$(i,P,.5),c.current)return;b({type:"done",payload:P})}catch(S){if(c.current)return;b({type:"error",payload:S})}},s={error:void 0,data:void 0,status:"idle",executeFetch:a},w=(z,h)=>{switch(h.type){case"loading":return{...s,status:"loading"};case"done":return{...s,data:h.payload,status:"done"};case"error":return{...s,error:h.payload,status:"error"};default:return z}},[W,b]=m.useReducer(w,s);return m.useLayoutEffect(()=>{o&&a()},[i]),W}const _=({repoName:i})=>{const{data:r,status:o}=M(`https://api.github.com/repos/najwer23/${i}/branches/gh-pages`,{method:"GET"});let c="";return o==="done"&&(c=new Date(r.commit.commit.committer.date).toLocaleString("pl-PL",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit",year:"numeric"})),e.jsx(e.Fragment,{children:c||" "})},ee=()=>{const{lang:i,setLang:r}=F(),o=()=>{window.print()};return e.jsxs(K,{children:[e.jsx(Y,{children:e.jsx(_,{repoName:"resume"})}),e.jsxs(Z,{children:[e.jsx(I,{text:"EN",type:"button",ariaLabel:"lang En",onClick:()=>r("en"),disabled:i==="en"}),e.jsx(I,{text:"PL",type:"button",ariaLabel:"lang Pl",onClick:()=>r("pl"),disabled:i==="pl"}),e.jsx(I,{text:e.jsx(D,{icon:B,size:"xl",style:{color:"white"}}),type:"button",ariaLabel:"lang En",onClick:()=>o()})]})]})},te=n.div`
	margin: 1cm auto;
